...
@media (min-width: 1200px) {
	...
	.col-sm-12.pesan .col-sm-3 button {
		margin-bottom: 4em;
		width: 100%;
		margin-left: 0;
	}
...
@media (max-width: 576px) {
		...
		padding-top: 1em;
				...
				<div class="col-sm-12 pesan">
					...
					<div class="col-sm-7 float-left">
						...
						<label class="col-sm-9 sts">
							DIBAYAR - An. Ilhamz Q - BCA Payment
							<br>
							Alamat: Malang
						</label>
					</div>
					<div class="col-sm-3 float-left">
						<form onsubmit="return cekres(1)" method="post">
							<input type="text" id="resi1" name="resi1" maxlength="20" placeholder="No Resi Pengiriman" />
							<input type="file" onChange="cekfoto(1)" id="foto1" name="foto1" accept="image/*" style="text-align: left;" />							
							<button type="submit" class="btnordpro">Proses</button>
						</form>						
					</div>					
				</div>
			</div>
	...
	<script>
	    function cekres(e) {
        	if (document.getElementById('resi'+e).value=='' || document.getElementById('foto'+e).value=='') {
        		return false;
        	}
